...
public class SurveyServiceTest {
    ...
    void 설문을_생성한다() throws Exception {
        ...
        when(aiModerationFacade.checkTitleModeration(eq(userId), eq("테스트설문제목")))
                .thenReturn(AiModerationResult.of(null, AiModerationResultStatusEnum.APPROVED));
        when(aiModerationFacade.checkDescriptionModeration(eq(userId), eq("테스트설문내용")))
                .thenReturn(AiModerationResult.of(null, AiModerationResultStatusEnum.APPROVED));
    ...
    void 설문_상세정보를_수정한다(){
        ...
        when(aiModerationFacade.checkTitleModeration(eq(userId), eq("테스트설문제목수정")))
                .thenReturn(AiModerationResult.of(null, AiModerationResultStatusEnum.APPROVED));
        when(aiModerationFacade.checkDescriptionModeration(eq(userId), eq("테스트설문내용수정")))
                .thenReturn(AiModerationResult.of(null, AiModerationResultStatusEnum.APPROVED));
