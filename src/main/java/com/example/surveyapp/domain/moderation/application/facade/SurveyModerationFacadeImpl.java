package com.example.surveyapp.domain.moderation.application.facade;

import com.example.surveyapp.domain.moderation.application.AiModerationService;
import com.example.surveyapp.domain.moderation.domain.model.enums.AiModerationTargetType;
